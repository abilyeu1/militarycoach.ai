...
//interface imports
import { SkillsGapAnalysisChatBarProps } from "@/types/tools.interface";
...
const ChatBar: FC<SkillsGapAnalysisChatBarProps> = ({
  questions,
  ...
  return (
    <>
      <LeftBar
        ...
        routerPath={`history/skills-gap-analysis`}
      >
        {loader && (
          ...
          <div className="">
            ...
            >
              <div className="my-5 flex ">
                <div
                  className={`mb-2 ml-4 mr-0 flex-1 rounded-lg p-1 md:mr-0 md:p-5 lg:relative `}
                >
                  {history.slice(2).map((item: any, index: number) => (
                    ...
                    >
                      {item.content && (
                        <pre
                          className={`relative my-5 whitespace-pre-wrap pt-12 ${
                            item.role === "user"
